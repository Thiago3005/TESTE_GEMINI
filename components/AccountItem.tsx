...
const AccountItem: React.FC<AccountItemProps> = ({ 
  account, balance, onEdit, onDelete, transactionCount, isPrivacyModeEnabled 
}) => {
  return (
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-xs text-textMuted dark:text-textMutedDark mt-1">
            Saldo Inicial: {formatCurrency(account.initial_balance, 'BRL', 'pt-BR', isPrivacyModeEnabled)}
          </p>
        </div>
