...
interface MoneyBoxTransactionFormModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (transaction: MoneyBoxTransaction, createLinkedTransaction: boolean, linkedAccountId?: string) => void;
  moneyBox: MoneyBox;
...
const MoneyBoxTransactionFormModal: React.FC<MoneyBoxTransactionFormModalProps> = ({
  ...
  const handleSubmit = () => {
    ...
    const transactionData: MoneyBoxTransaction = {
      id: generateId(),
      ...
      // linkedAccountId and linkedTransactionId will be handled by onSave callback if createLinkedTransaction is true
    };
